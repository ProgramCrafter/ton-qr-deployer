...
var app = (function () {
    ...
    const file$7 = "src/HorizontalLine.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 13, 0, 201);
    		},
    ...
    class HorizontalLine extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { margin: 0, color: 1 });
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Warning: invalid mnemonic";
    			add_location(div, file$6, 54, 4, 1444);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    // (59:4) {#each Object.entries(address_list) as [wallet_name, addr]}
    function create_each_block$1(ctx) {
    	let div;
    	let t0_value = /*wallet_name*/ ctx[9] + "";
    	let t0;
    	let t1;
    	let t2_value = /*addr*/ ctx[10] + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(": ");
    			t2 = text(t2_value);
    			add_location(div, file$6, 59, 6, 1581);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*address_list*/ 16 && t0_value !== (t0_value = /*wallet_name*/ ctx[9] + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*address_list*/ 16 && t2_value !== (t2_value = /*addr*/ ctx[10] + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:4) {#each Object.entries(address_list) as [wallet_name, addr]}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = !/*mnemonic_valid*/ ctx[3] && create_if_block(ctx);
    	let each_value = Object.entries(/*address_list*/ ctx[4]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			div1 = element("div");
    			t3 = text("Deploying: mc:");
    			t4 = text(/*is_masterchain*/ ctx[0]);
    			t5 = text(", ts:");
    			t6 = text(/*is_testnet*/ ctx[1]);
    			attr_dev(textarea, "placeholder", "24 mnemonic words");
    			attr_dev(textarea, "class", "svelte-1a50m0t");
    			add_location(textarea, file$6, 51, 2, 1339);
    			attr_dev(div0, "id", "wallets");
    			attr_dev(div0, "class", "svelte-1a50m0t");
    			add_location(div0, file$6, 57, 2, 1492);
    			add_location(div1, file$6, 63, 2, 1638);
    			attr_dev(div2, "class", "root svelte-1a50m0t");
    			add_location(div2, file$6, 50, 0, 1293);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea, /*mnemonic*/ ctx[2]);
    			append_dev(div2, t0);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div2, "click", stop_propagation(/*click_handler*/ ctx[6]), false, false, true, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*Object, address_list*/ 16) {
    				each_value = Object.entries(/*address_list*/ ctx[4]);
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty & /*is_masterchain*/ 1) set_data_dev(t4, /*is_masterchain*/ ctx[0]);
    			if (dirty & /*is_testnet*/ 2) set_data_dev(t6, /*is_testnet*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('MnemonicPopup', slots, []);
    	let { is_masterchain } = $$props;
    	let { is_testnet } = $$props;
    	let { as_plugin } = $$props;
    	...
    	async function fill_address_list(_mnemonic) {
    		if (!_mnemonic) return;
    		$$invalidate(3, mnemonic_valid = await TWM.validateMnemonic(mnemonic.split(' ')));
    		...
    		for (let [wallet_name, wallet_constructor] of Object.entries(TonWeb.Wallets.all)) {
    			...
    			$$invalidate(4, address_list[wallet_name] = (await wallet.getAddress()).toString(true, true, true), address_list);
    		}
    	}

    	$$self.$$.on_mount.push(function () {
    		if (is_masterchain === undefined && !('is_masterchain' in $$props || $$self.$$.bound[$$self.$$.props['is_masterchain']])) {
    			console_1$1.warn("<MnemonicPopup> was created without expected prop 'is_masterchain'");
    		}

    		if (is_testnet === undefined && !('is_testnet' in $$props || $$self.$$.bound[$$self.$$.props['is_testnet']])) {
    			console_1$1.warn("<MnemonicPopup> was created without expected prop 'is_testnet'");
    		}

    		if (as_plugin === undefined && !('as_plugin' in $$props || $$self.$$.bound[$$self.$$.props['as_plugin']])) {
    			console_1$1.warn("<MnemonicPopup> was created without expected prop 'as_plugin'");
    		}
    	});

    	const writable_props = ['is_masterchain', 'is_testnet', 'as_plugin'];

    	Object_1$1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<MnemonicPopup> was created with unknown prop '${key}'`);
    	});
    	...
    	function textarea_input_handler() {
    		mnemonic = this.value;
    		$$invalidate(2, mnemonic);
    	}

    	$$self.$$set = $$props => {
    		if ('is_masterchain' in $$props) $$invalidate(0, is_masterchain = $$props.is_masterchain);
    		if ('is_testnet' in $$props) $$invalidate(1, is_testnet = $$props.is_testnet);
    		if ('as_plugin' in $$props) $$invalidate(5, as_plugin = $$props.as_plugin);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('is_testnet' in $$props) $$invalidate(1, is_testnet = $$props.is_testnet);
    		if ('as_plugin' in $$props) $$invalidate(5, as_plugin = $$props.as_plugin);
    		if ('mnemonic' in $$props) $$invalidate(2, mnemonic = $$props.mnemonic);
    		if ('mnemonic_valid' in $$props) $$invalidate(3, mnemonic_valid = $$props.mnemonic_valid);
    		if ('address_list' in $$props) $$invalidate(4, address_list = $$props.address_list);
    	};
    ...
    class MnemonicPopup extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get is_masterchain() {
    		throw new Error("<MnemonicPopup>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set is_masterchain(value) {
    		throw new Error("<MnemonicPopup>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    */
    ...
    /* src/QRPopup.svelte generated by Svelte v3.59.1 */
    const file$5 = "src/QRPopup.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$5, 10, 0, 223);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(canvas_1, "click", stop_propagation(/*click_handler*/ ctx[2]), false, false, true, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('QRPopup', slots, []);
    	let canvas;
    	let { link = 'ton://null' } = $$props;
    	const writable_props = ['link'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<QRPopup> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ canvas, link, QRCode: browser });
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*canvas, link*/ 3) {
    			if (canvas) browser.toCanvas(canvas, link);
    		}
    	};

    	return [canvas, link, click_handler, canvas_1_binding];
    }

    class QRPopup extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { link: 1 });
    	...
    	get link() {
    		throw new Error("<QRPopup>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set link(value) {
    		throw new Error("<QRPopup>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/DeployPanel.svelte generated by Svelte v3.59.1 */

    const { console: console_1 } = globals;
    const file$4 = "src/DeployPanel.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "Deploy with ton:// link";
    			t1 = space();
    			button1 = element("button");
    			button1.textContent = "Deploy with TON Connect 2";
    			t3 = space();
    			button2 = element("button");
    			button2.textContent = "Deploy with mnemonic";
    			t5 = space();
    			button3 = element("button");
    			t6 = text("Deploy ");
    			b0 = element("b");
    			b0.textContent = "as plugin";
    			br0 = element("br");
    			t8 = text("\n                   with mnemonic (v4r2 only)");
    			br1 = element("br");
    			t9 = space();
    			b1 = element("b");
    			b1.textContent = "(CAN TAKE ALL FUNDS)";
    			attr_dev(button0, "class", "svelte-1ukqfrm");
    			add_location(button0, file$4, 114, 2, 3034);
    			button1.disabled = true;
    			attr_dev(button1, "class", "svelte-1ukqfrm");
    			add_location(button1, file$4, 115, 2, 3101);
    			button2.disabled = true;
    			attr_dev(button2, "class", "svelte-1ukqfrm");
    			add_location(button2, file$4, 116, 2, 3155);
    			add_location(b0, file$4, 117, 31, 3233);
    			add_location(br0, file$4, 117, 47, 3249);
    			add_location(br1, file$4, 118, 44, 3298);
    			add_location(b1, file$4, 119, 19, 3322);
    			button3.disabled = true;
    			attr_dev(button3, "class", "svelte-1ukqfrm");
    			add_location(button3, file$4, 117, 2, 3204);
    			attr_dev(div, "class", "panel svelte-1ukqfrm");
    			add_location(div, file$4, 113, 0, 3012);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(button3, b0);
    			append_dev(button3, br0);
    			append_dev(button3, t8);
    			append_dev(button3, br1);
    			append_dev(button3, t9);
    			append_dev(button3, b1);

    			if (!mounted) {
    				dispose = listen_dev(button0, "click", /*popup_ton_qr*/ ctx[0], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('DeployPanel', slots, []);
    	let { code } = $$props;
    	let { data } = $$props;
    	...
    	$$self.$$.on_mount.push(function () {
    		if (code === undefined && !('code' in $$props || $$self.$$.bound[$$self.$$.props['code']])) {
    			console_1.warn("<DeployPanel> was created without expected prop 'code'");
    		}

    		if (data === undefined && !('data' in $$props || $$self.$$.bound[$$self.$$.props['data']])) {
    			console_1.warn("<DeployPanel> was created without expected prop 'data'");
    		}

    		if (popup_wrapper === undefined && !('popup_wrapper' in $$props || $$self.$$.bound[$$self.$$.props['popup_wrapper']])) {
    			console_1.warn("<DeployPanel> was created without expected prop 'popup_wrapper'");
    		}

    		if (is_masterchain === undefined && !('is_masterchain' in $$props || $$self.$$.bound[$$self.$$.props['is_masterchain']])) {
    			console_1.warn("<DeployPanel> was created without expected prop 'is_masterchain'");
    		}
    	});

    	const writable_props = ['code', 'data', 'popup_wrapper', 'is_masterchain'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<DeployPanel> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ('code' in $$props) $$invalidate(1, code = $$props.code);
    		if ('data' in $$props) $$invalidate(2, data = $$props.data);
    		if ('popup_wrapper' in $$props) $$invalidate(3, popup_wrapper = $$props.popup_wrapper);
    		if ('is_masterchain' in $$props) $$invalidate(4, is_masterchain = $$props.is_masterchain);
    	};
    	...
    	return [popup_ton_qr, code, data, popup_wrapper, is_masterchain];
    }

    class DeployPanel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get code() {
    		throw new Error("<DeployPanel>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set code(value) {
    		throw new Error("<DeployPanel>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/InitInput.svelte generated by Svelte v3.59.1 */

    const { Error: Error_1, Object: Object_1 } = globals;
    const file$3 = "src/InitInput.svelte";
    ...
    // (63:4) {#each Object.entries(default_contract_code) as [display, boc]}
    function create_each_block_1(ctx) {
    	let button;
    	let t_value = /*display*/ ctx[13] + "";
    	let t;
    	let mounted;
    	let dispose;

    	function click_handler() {
    		return /*click_handler*/ ctx[9](/*boc*/ ctx[14]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			add_location(button, file$3, 63, 4, 2495);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:4) {#each Object.entries(default_contract_code) as [display, boc]}",
    		ctx
    	});
    ...
    // (72:4) {#each Object.entries(default_contract_data) as [display, boc]}
    function create_each_block(ctx) {
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[11](/*boc*/ ctx[14]);
    	}
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			t = text(t_value);
    			add_location(button, file$3, 72, 4, 2825);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(72:4) {#each Object.entries(default_contract_data) as [display, boc]}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	let t1;
    	let span0;
    	let t2_value = (/*code_error*/ ctx[2] || 'Code BOC parsed successfully') + "";
    	let t2;
    	let t3;
    	let div3;
    	let textarea1;
    	...
    	let t5;
    	let span1;
    	let t6_value = (/*data_error*/ ctx[3] || 'Data BOC parsed successfully') + "";
    	let t6;
    	let mounted;
    	let dispose;
    	let each_value_1 = Object.entries(/*default_contract_code*/ ctx[4]);
    	...
    	let each_value = Object.entries(/*default_contract_data*/ ctx[5]);
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			span1 = element("span");
    			t6 = text(t6_value);
    			attr_dev(textarea0, "placeholder", "Contract code BOC");
    			attr_dev(textarea0, "class", "svelte-163v3c3");
    			add_location(textarea0, file$3, 60, 2, 2338);
    			add_location(span0, file$3, 65, 4, 2574);
    			add_location(div0, file$3, 61, 2, 2417);
    			attr_dev(div1, "id", "code");
    			attr_dev(div1, "class", "svelte-163v3c3");
    			add_location(div1, file$3, 59, 0, 2320);
    			attr_dev(textarea1, "placeholder", "Contract data BOC");
    			attr_dev(textarea1, "class", "svelte-163v3c3");
    			add_location(textarea1, file$3, 69, 2, 2668);
    			add_location(span1, file$3, 74, 4, 2904);
    			add_location(div2, file$3, 70, 2, 2747);
    			attr_dev(div3, "id", "data");
    			attr_dev(div3, "class", "svelte-163v3c3");
    			add_location(div3, file$3, 68, 0, 2650);
    		},
    		l: function claim(nodes) {
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(textarea0, /*code_text*/ ctx[0]);
    			append_dev(div1, t0);
    			...
    			set_input_value(textarea1, /*data_text*/ ctx[1]);
    			append_dev(div3, t4);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*code_text*/ 1) {
    				set_input_value(textarea0, /*code_text*/ ctx[0]);
    			}

    			if (dirty & /*code_text, Object, default_contract_code*/ 17) {
    				each_value_1 = Object.entries(/*default_contract_code*/ ctx[4]);
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*code_error*/ 4 && t2_value !== (t2_value = (/*code_error*/ ctx[2] || 'Code BOC parsed successfully') + "")) set_data_dev(t2, t2_value);

    			if (dirty & /*data_text*/ 2) {
    				set_input_value(textarea1, /*data_text*/ ctx[1]);
    			}

    			if (dirty & /*data_text, Object, default_contract_data*/ 34) {
    				each_value = Object.entries(/*default_contract_data*/ ctx[5]);
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (dirty & /*data_error*/ 8 && t6_value !== (t6_value = (/*data_error*/ ctx[3] || 'Data BOC parsed successfully') + "")) set_data_dev(t6, t6_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('InitInput', slots, []);
    	...
    	const default_contract_data = { 'Empty cell': '' };
    	let { code = null } = $$props;
    	let { data = null } = $$props;
    	let code_text = '';
    	let data_text = '';
    	let code_error = '';
    	let data_error = '';
    	const writable_props = ['code', 'data'];

    	Object_1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<InitInput> was created with unknown prop '${key}'`);
    	});

    	function textarea0_input_handler() {
    		code_text = this.value;
    		$$invalidate(0, code_text);
    	}

    	const click_handler = boc => {
    		$$invalidate(0, code_text = boc);
    	};

    	function textarea1_input_handler() {
    		data_text = this.value;
    		$$invalidate(1, data_text);
    	}

    	const click_handler_1 = boc => {
    		$$invalidate(1, data_text = boc);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ('code' in $$props) $$invalidate(6, code = $$props.code);
    		if ('data' in $$props) $$invalidate(7, data = $$props.data);
    		if ('code_text' in $$props) $$invalidate(0, code_text = $$props.code_text);
    		if ('data_text' in $$props) $$invalidate(1, data_text = $$props.data_text);
    		if ('code_error' in $$props) $$invalidate(2, code_error = $$props.code_error);
    		if ('data_error' in $$props) $$invalidate(3, data_error = $$props.data_error);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*code_text*/ 1) {
    			try {
    				$$invalidate(6, code = boc_to_cell(code_text));
    				$$invalidate(2, code_error = '');
    			} catch(e) {
    				$$invalidate(2, code_error = '' + e);
    			}
    		}

    		if ($$self.$$.dirty & /*data_text*/ 2) {
    			try {
    				$$invalidate(7, data = boc_to_cell(data_text));
    				$$invalidate(3, data_error = '');
    			} catch(e) {
    				$$invalidate(3, data_error = '' + e);
    			}
    		}
    	};
    ...
    class InitInput extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { code: 6, data: 7 });
    	...
    	get code() {
    		throw new Error_1("<InitInput>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set code(value) {
    		throw new Error_1("<InitInput>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_fragment$2(ctx) {
    	...
    	let span1;
    	let t5;
    	let t6_value = (/*is_testnet*/ ctx[0] ? 'testnet' : 'mainnet') + "";
    	let t6;
    	let t7;
    	let button1;
    	let span2;

    	let t8_value = (/*is_masterchain*/ ctx[1]
    	? 'masterchain (-1)'
    	: 'basechain (0)') + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			span3 = element("span");
    			span3.textContent = "Tools ring:";
    			t11 = text(" \n    ");
    			a0 = element("a");
    			a0.textContent = "[Ratelance]";
    			t13 = text(" \n    ");
    			a1 = element("a");
    			a1.textContent = "[ChainArrowViewer]";
    			t15 = space();
    			div4 = element("div");
    			a2 = element("a");
    			a2.textContent = "EQCyoez1VF4HbNNq5Rbqfr3zKuoAjKorhK-YZr7LIIiVrSD7";
    			attr_dev(div0, "class", "icon svelte-17rjlut");
    			add_location(div0, file$2, 48, 4, 820);
    			set_style(span0, "height", "100%");
    			set_style(span0, "display", "inline-flex");
    			set_style(span0, "font-weight", "800");
    			set_style(span0, "font-size", "18px");
    			attr_dev(span0, "class", "svelte-17rjlut");
    			add_location(span0, file$2, 49, 4, 849);
    			attr_dev(div1, "class", "svelte-17rjlut");
    			add_location(div1, file$2, 47, 2, 810);
    			attr_dev(div2, "class", "fill-space svelte-17rjlut");
    			add_location(div2, file$2, 53, 2, 976);
    			attr_dev(img, "class", "icon svelte-17rjlut");
    			if (!src_url_equal(img.src, img_src_value = "https://ton.org/download/ton_symbol.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "TON logo");
    			toggle_class(img, "greyout", /*is_testnet*/ ctx[0]);
    			add_location(img, file$2, 55, 4, 1063);
    			attr_dev(span1, "class", "svelte-17rjlut");
    			add_location(span1, file$2, 56, 4, 1176);
    			attr_dev(button0, "class", "svelte-17rjlut");
    			add_location(button0, file$2, 54, 2, 1005);
    			attr_dev(span2, "class", "svelte-17rjlut");
    			add_location(span2, file$2, 59, 4, 1311);
    			attr_dev(button1, "class", "svelte-17rjlut");
    			add_location(button1, file$2, 58, 2, 1245);
    			attr_dev(span3, "class", "svelte-17rjlut");
    			add_location(span3, file$2, 62, 4, 1420);
    			attr_dev(a0, "href", "https://ratingers.pythonanywhere.com/ratelance/");
    			add_location(a0, file$2, 63, 4, 1455);
    			attr_dev(a1, "href", "https://ratingers.pythonanywhere.com/tx-explorer/");
    			add_location(a1, file$2, 64, 4, 1539);
    			attr_dev(div3, "class", "rounded svelte-17rjlut");
    			add_location(div3, file$2, 61, 2, 1394);
    			attr_dev(a2, "href", "ton://transfer/EQCyoez1VF4HbNNq5Rbqfr3zKuoAjKorhK-YZr7LIIiVrSD7");
    			add_location(a2, file$2, 67, 4, 1671);
    			attr_dev(div4, "class", "rounded warn-border svelte-17rjlut");
    			add_location(div4, file$2, 66, 2, 1633);
    			attr_dev(header, "class", "svelte-17rjlut");
    			add_location(header, file$2, 46, 0, 799);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*is_testnet*/ 1 && t6_value !== (t6_value = (/*is_testnet*/ ctx[0] ? 'testnet' : 'mainnet') + "")) set_data_dev(t6, t6_value);

    			if (dirty & /*is_masterchain*/ 2 && t8_value !== (t8_value = (/*is_masterchain*/ ctx[1]
    			? 'masterchain (-1)'
    			: 'basechain (0)') + "")) set_data_dev(t8, t8_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { is_masterchain = false } = $$props;
    	const writable_props = ['is_testnet', 'is_masterchain'];
    	...
    	const click_handler_1 = () => {
    		$$invalidate(1, is_masterchain = !is_masterchain);
    	};

    	$$self.$$set = $$props => {
    		if ('is_testnet' in $$props) $$invalidate(0, is_testnet = $$props.is_testnet);
    		if ('is_masterchain' in $$props) $$invalidate(1, is_masterchain = $$props.is_masterchain);
    	};

    	$$self.$capture_state = () => ({ is_testnet, is_masterchain });
    	...
    	return [is_testnet, is_masterchain, click_handler, click_handler_1];
    }

    class Header extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { is_testnet: 0, is_masterchain: 1 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 20, 0, 364);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Popup extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { popup_wrapper: 0 });
    ...
    function create_fragment(ctx) {
    	...
    	function header_is_masterchain_binding(value) {
    		/*header_is_masterchain_binding*/ ctx[5](value);
    	}

    	function header_is_testnet_binding(value) {
    		/*header_is_testnet_binding*/ ctx[6](value);
    	}

    	let header_props = {};

    	if (/*is_masterchain*/ ctx[1] !== void 0) {
    		header_props.is_masterchain = /*is_masterchain*/ ctx[1];
    	}

    	if (/*is_testnet*/ ctx[2] !== void 0) {
    		header_props.is_testnet = /*is_testnet*/ ctx[2];
    	}

    	header = new Header({ props: header_props, $$inline: true });
    	binding_callbacks.push(() => bind(header, 'is_masterchain', header_is_masterchain_binding));
    	...
    	function initinput_code_binding(value) {
    		/*initinput_code_binding*/ ctx[7](value);
    	}

    	function initinput_data_binding(value) {
    		/*initinput_data_binding*/ ctx[8](value);
    	}

    	let initinput_props = {};

    	if (/*code*/ ctx[3] !== void 0) {
    		initinput_props.code = /*code*/ ctx[3];
    	}

    	if (/*data*/ ctx[4] !== void 0) {
    		initinput_props.data = /*data*/ ctx[4];
    	}

    	initinput = new InitInput({ props: initinput_props, $$inline: true });
    	binding_callbacks.push(() => bind(initinput, 'code', initinput_code_binding));
    	binding_callbacks.push(() => bind(initinput, 'data', initinput_data_binding));
    	...
    	deploypanel = new DeployPanel({
    			props: {
    				code: /*code*/ ctx[3],
    				data: /*data*/ ctx[4],
    				popup_wrapper: /*popup_wrapper*/ ctx[0],
    				is_masterchain: /*is_masterchain*/ ctx[1]
    			},
    			$$inline: true
    		});

    	function popup_popup_wrapper_binding(value) {
    		/*popup_popup_wrapper_binding*/ ctx[9](value);
    	}

    	let popup_props = {};

    	if (/*popup_wrapper*/ ctx[0] !== void 0) {
    		popup_props.popup_wrapper = /*popup_wrapper*/ ctx[0];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			create_component(initinput.$$.fragment);
    			t4 = space();
    			create_component(horizontalline1.$$.fragment);
    			t5 = space();
    			create_component(deploypanel.$$.fragment);
    			t6 = space();
    			create_component(popup.$$.fragment);
    			add_location(style, file, 3, 2, 123);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, t3, anchor);
    			mount_component(initinput, target, anchor);
    			insert_dev(target, t4, anchor);
    			mount_component(horizontalline1, target, anchor);
    			insert_dev(target, t5, anchor);
    			mount_component(deploypanel, target, anchor);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_is_masterchain && dirty & /*is_masterchain*/ 2) {
    				updating_is_masterchain = true;
    				header_changes.is_masterchain = /*is_masterchain*/ ctx[1];
    				add_flush_callback(() => updating_is_masterchain = false);
    			}

    			if (!updating_is_testnet && dirty & /*is_testnet*/ 4) {
    				updating_is_testnet = true;
    				header_changes.is_testnet = /*is_testnet*/ ctx[2];
    				add_flush_callback(() => updating_is_testnet = false);
    			}

    			header.$set(header_changes);
    			const initinput_changes = {};

    			if (!updating_code && dirty & /*code*/ 8) {
    				updating_code = true;
    				initinput_changes.code = /*code*/ ctx[3];
    				add_flush_callback(() => updating_code = false);
    			}

    			if (!updating_data && dirty & /*data*/ 16) {
    				updating_data = true;
    				initinput_changes.data = /*data*/ ctx[4];
    				add_flush_callback(() => updating_data = false);
    			}

    			initinput.$set(initinput_changes);
    			const deploypanel_changes = {};
    			if (dirty & /*code*/ 8) deploypanel_changes.code = /*code*/ ctx[3];
    			if (dirty & /*data*/ 16) deploypanel_changes.data = /*data*/ ctx[4];
    			if (dirty & /*popup_wrapper*/ 1) deploypanel_changes.popup_wrapper = /*popup_wrapper*/ ctx[0];
    			if (dirty & /*is_masterchain*/ 2) deploypanel_changes.is_masterchain = /*is_masterchain*/ ctx[1];
    			deploypanel.$set(deploypanel_changes);
    			const popup_changes = {};

    			if (!updating_popup_wrapper && dirty & /*popup_wrapper*/ 1) {
    				updating_popup_wrapper = true;
    				popup_changes.popup_wrapper = /*popup_wrapper*/ ctx[0];
    		...
    		i: function intro(local) {
    			...
    			transition_in(initinput.$$.fragment, local);
    			transition_in(horizontalline1.$$.fragment, local);
    			transition_in(deploypanel.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(initinput.$$.fragment, local);
    			transition_out(horizontalline1.$$.fragment, local);
    			transition_out(deploypanel.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			...
    			if (detaching) detach_dev(t3);
    			destroy_component(initinput, detaching);
    			if (detaching) detach_dev(t4);
    			destroy_component(horizontalline1, detaching);
    			if (detaching) detach_dev(t5);
    			destroy_component(deploypanel, detaching);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function header_is_masterchain_binding(value) {
    		is_masterchain = value;
    		$$invalidate(1, is_masterchain);
    	}

    	function header_is_testnet_binding(value) {
    		is_testnet = value;
    		$$invalidate(2, is_testnet);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('popup_wrapper' in $$props) $$invalidate(0, popup_wrapper = $$props.popup_wrapper);
    		if ('is_masterchain' in $$props) $$invalidate(1, is_masterchain = $$props.is_masterchain);
    		if ('is_testnet' in $$props) $$invalidate(2, is_testnet = $$props.is_testnet);
    	...
    	return [
    		...
    		code,
    		data,
    		header_is_masterchain_binding,
    		header_is_testnet_binding,
    		initinput_code_binding,
    		initinput_data_binding,
